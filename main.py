...
class Residual (nn.Module):
    def __init__(self):
        ...
        self.couche1 = nn.Conv2d(128, 128, kernel_size=3, padding=1)
        self.batchNorm1 = nn.BatchNorm2d(128)
        self.couche2 = nn.Conv2d(128, 128, kernel_size=3, padding=1)
...
class ImgTNet (nn.Module):
    def __init__(self):
        ...
        self.residual3 = Residual()
        self.residual4 = Residual()
        self.residual5 = Residual()
        self.conv4 = nn.ConvTranspose2d(128, 64, kernel_size=3, stride=2)
        self.batchNorm4 = nn.BatchNorm2d(64)
        self.conv5 = nn.ConvTranspose2d(64, 32, kernel_size=3, stride=2)
        self.batchNorm5 = nn.BatchNorm2d(32)
        self.conv6 = nn.ConvTranspose2d(32, 3, kernel_size=9, stride=1)
